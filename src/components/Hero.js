...
function Hero() {
    ...
    <div class="home-img">
        <img src="./assets/srikar.jpg" alt="SrikarDhanpal" />
    </div>
    ...
    <a href="https://www.linkedin.com/in/srikar-dhanpal-558ba6250/" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-linkedin"></i></a>
    <a href="https://github.com/SrikarDhanpal" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-github"></i></a>
